...
<body>
  <div class="principal">
        ...
        $query='SELECT `cod_articulo`, `nombre_articulo`, `descripcion_articulo`, `gramo`, `mililitro`, `importe_compra`, `importe_venta`, `punt_calidad_articulo`, `cantidad_minima` FROM `articulos_disponibles` WHERE cod_articulo="'.$_GET['cod_articulo'].'";';
                    ...
                    <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-2 justify-content-center align-items-center heigth">
                        <div class="col-11 heigth-84">
                            <div class="row alta border border-info rounded-3 justify-content-center align-items-center heigth">
                                <form class="col-11 heigth-84" method="GET" action="modificar_art_logica.php">
                                    <div class="row row-cols-1 justify-content-center"> 
                                        <div class="col"><div class="separador-1 "></div></div>
                                        <div class="col titulo_alta_p rounded fs-1">Modificar</div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row row-cols-1"> 
                                        <div class="col">
                                            <div class="form-floating width">
                                                <input type="text" class="form-control" id="floatingInputGrid" placeholder="name@example.com" name="codigo" value="<?php echo $fila['cod_articulo']; ?>">
                                    ...
                                    <div class="row row-cols-1 justify-content-center "> 
                                        <div class="col">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="floatingInputGrid" placeholder="name@example.com" name="nombre" value="<?php echo $fila['nombre_articulo']; ?>">
                                    ...
                                    <div class="row row-cols-1 justify-content-center "> 
                                        <div class="col">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="floatingInputGrid" placeholder="name@example.com" name="descripcion" value="<?php echo $fila['descripcion_articulo']; ?>">
                                    ...
                                    <div class="row row-cols-1 justify-content-center "> 
                                        <div class="col">
                                        <div class="form-floating">
                                                <input type="number" class="form-control" id="floatingInputGrid" placeholder="name@example.com" name="gramo" value="<?php echo $fila['gramo']; ?>">
                                    ...
                                    <div class="row row-cols-1 justify-content-center "> 
                                        <div class="col">
                                        <div class="form-floating">
                                                <input type="number" class="form-control" id="floatingInputGrid" placeholder="name@example.com" name="mililitro" value="<?php echo $fila['mililitro']; ?>">
                                    ...
                                    <div class="row row-cols-1 justify-content-center "> 
                                        <div class="col">
                                            <div class="form-floating">
                                              <input type="number" class="form-control" id="floatingInputGrid" placeholder="name@example.com" name="importe_compra" value="<?php echo $fila['importe_compra']; ?>">
                                    ...
                                    <div class="row row-cols-1 justify-content-center "> 
                                        <div class="col">
                                        <div class="form-floating">
                                                <input type="number" class="form-control" id="floatingInputGrid" placeholder="name@example.com" name="importe_venta" value="<?php echo $fila['importe_venta']; ?>">
                                    ...
                                    <div class="row row-cols-1 justify-content-center "> 
                                        <div class="col">
                                        <div class="form-floating">
                                                <input type="number" class="form-control" id="floatingInputGrid" placeholder="name@example.com" name="calidad" value="<?php echo $fila['punt_calidad_articulo']; ?>">
                                    ...
                                    <div class="row row-cols-2 justify-content-center"> 
                                        <div class="col-8">
                                            <div class="form-floating">
                                                <input type="number" class="form-control" id="floatingInputGrid" placeholder="name@example.com" name="cant_min" value="<?php echo $fila['cantidad_minima']; ?>">
