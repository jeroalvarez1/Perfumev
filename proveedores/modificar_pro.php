<?php
    ...
    $query="SELECT `cod_proveedor`, `nombre_proveedor`, `apellido_proveedor`, `dni_proveedor`, `estado_proveedor`, `tipo_proveedor`, `domicilio_proveedor`, `punt_calidad_proveedor` FROM `proveedor` WHERE cod_proveedor = $cod_proveedor";
    ...
    $apellido = $fila['apellido_proveedor'];
    $dni = $fila['dni_proveedor'];
    $estado = $fila['estado_proveedor'];
    $tipo = $fila['tipo_proveedor'];
    $domicilio = $fila['domicilio_proveedor'];
    $calificacion = $fila['punt_calidad_proveedor'];
?>
                    ...
                    <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-2 justify-content-center align-items-center heigth">
                        <div class="col-11 heigth-84">
                            <div class="row alta border border-info rounded-3 justify-content-center align-items-center heigth">
                                <form class="col-11 heigth-84" method="GET" action="modificar_pro_logico.php">
                                    <input type="hidden" name="cod_cliente" value="<?php echo $cod_proveedor; ?>">
