...
<head>
    ...
    <link href="proveedores.php" rel="stylesheet" type="text/css">
            ...
            <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 justify-content-center margen">
                ...
                <div class="col selector-partes-2 altura rounded-pill ">
                  <div class="row justify-content-center">
                    ...
                    <div class="col-2 flexible_end">
                      <form method="GET" action="alta_pro.php">
              ...
              <div class="col-sm-12 table-responsive pri_tabla">
                <?php 
                    ...
                    $query='SELECT cod_proveedor, nombre_proveedor, apellido_proveedor, dni_proveedor, estado_proveedor, tipo_proveedor, domicilio_proveedor, punt_calidad_proveedor FROM proveedor WHERE (nombre_proveedor LIKE "%'.$busqueda.'%") OR (apellido_proveedor LIKE "%'.$busqueda.'%");';
                        ...
                        echo "<tbody>";
                          echo "<tr class='border border-dark'>";
                            echo "<td class='border border-dark'>";
                              echo $fila['cod_proveedor'];
                            echo "</td>";
                            echo "<td class='border border-dark'>";
                              echo $fila['nombre_proveedor'];
                            echo "</td>";
                            echo "<td class='border border-dark'>";
                              echo $fila['apellido_proveedor'];
                            echo "</td>";
                            echo "<td class='border border-dark'>";
                              echo $fila['dni_proveedor'];
                            echo "</td>";
                            echo "<td class='border border-dark'>";
                              echo $fila['estado_proveedor'];
                            echo "</td>";
                            echo "<td class='border border-dark'>";
                              echo $fila['tipo_proveedor'];
                            echo "</td>";
                            echo "<td class='border border-dark'>";
                              echo $fila['domicilio_proveedor'];
                            echo "</td>";
                            echo "<td class='border border-dark'>";
                              echo $fila['punt_calidad_proveedor'];
                            echo "</td>";
                            echo "<td class='border border-dark'>";
                                echo '<a style href="modificar_pro.php?cod_proveedor='.$fila['cod_proveedor'].'"><button class="btn btn-warning">Modificar</button></a>';
                            echo "</td>";
                            echo "<td class='border border-dark'>";
                              echo '<a href="borrar_pro.php?cod_proveedor='.$fila['cod_proveedor'].'"><button class="btn btn-danger">Borrar</button></a>';
                            echo "</td>";
                          echo "</tr>";
                        echo "</tbody>";
                      }
