                                        ...
                                        <div class="row row-cols-2 row-cols-sm-2 row-cols-md-2 row-cols-lg-2 align-items-center justify-content-start">
                                            <div class="col">
                                                <div class="row row-cols-2 row-cols-sm-2 row-cols-md-2 row-cols-lg-2">
                                                    <div class="col">
                                                        <div class="mb-3">
                                                            <input class="form-control" type="text" value="N° pedido <?php echo $_GET['num_pedido'];?>" aria-label="Disabled input example" disabled readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="row row-cols-2">
                                                            <div class="col">
                                                                <form action="gestion_pedidos.php" method="GET">
                                                                    <input type="hidden" name="confirmar" value='1'>
                                                                    <input type="hidden" name="n_envio" value='<?php echo $_GET['num_pedido'];?>'>
                                    ...
                                    <div class="col table-responsive ">
                                        <?php
                                            ...
                                            echo "</thead>";
                                                ...
                                                $query='SELECT `n`, `cod_articulo`, `cantidad`, `num_pedido` FROM `articulo_pedido_cli` WHERE num_pedido='.$_GET['num_pedido'].';';
                                                        ...
                                                        echo '<form method="GET" action="#">';
                                                            echo "<tbody>";
                                                                echo "<tr>";
                                                                    ...
                                                                    echo "<td>";
                                                                        echo '<div class="mb-3">';
                                                                            echo '<input type="hidden" name="cantidad_pedido" value='.$fila['cantidad'].'>';
                                                                            echo '<input class="form-control" type="number" value='.$fila['cantidad'].' aria-label="Disabled input example" disabled readonly>';
                                                                        echo '</div>';
                                                                    echo "</td>";
                                                                echo "</tr>";
                                                            echo "</tbody>";
