...
<body>
    <?php
        ...
        $query='SELECT proveedor.nombre_proveedor, proveedor.apellido_proveedor, proveedor.cod_proveedor FROM proveedor, pedido_proveedor WHERE (SELECT pedido_proveedor.cod_proveedor WHERE num_envio='.$_GET['num_envio'].')=proveedor.cod_proveedor;';
            ...
            <div class="container-fluid">
                <div class="row row-cols-1">
                    ...
                    <div class="col fondo-gris border border-2">
                        <form action="inconveniente_envio.php" method="GET" class="row row-cols-1">
                            <div class="col"><div class="separador-1 "></div></div>
                            <div class="col">
                                <input class="form-control" type="text" value="<?php echo 'Para el proveedor: '.$fila['nombre_proveedor'].' '.$fila['apellido_proveedor'];?>" aria-label="Disabled input example" disabled readonly>
                                <input type="hidden" name="num_envio" value="<?php echo $_GET['num_envio'];?>">
                                <input type="hidden" name="cod_proveedor" value="<?php echo $fila['cod_proveedor'];?>">
                            </div>
                            <div class="col"><div class="separador-1 "></div></div>
                            <div class="col">
                                <div class="mb-3">
