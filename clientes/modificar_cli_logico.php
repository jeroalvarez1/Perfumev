<?php
    ...
    $query="UPDATE `clientes` SET `cod_cliente`=".$cod_cliente.",`nombre_cliente`='".$nombre_cliente."',`apellido_cliente`='".$apellido_cliente."',`dni_cliente`='".$dni_cliente."',`estado_cliente`='".$estado_cliente."',`tipo_cliente`='".$tipo_cliente."',`domicilio_cliente`='".$domicilio_cliente."',`punt_calidad_cliente`=".$calificacion_cliente." WHERE cod_cliente=$cod_cliente;";
